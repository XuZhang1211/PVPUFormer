...
def resnet34_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        '''
        filtered_orig_dict = torch.load('/home/zx/.cache/torch/hub/checkpoints/gluon_resnet34_v1b-c6d82d59.pth',map_location='cpu')#['state_dict']
...
def resnet50_v1s(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        filtered_orig_dict = torch.load('/home/zx/.cache/torch/hub/checkpoints/gluon_resnet50_v1s-1762acc0.pth',map_location='cpu')#['state_dict']
        model_dict.update(filtered_orig_dict)
        model.load_state_dict(model_dict)
    return model
